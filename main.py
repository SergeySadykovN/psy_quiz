...
ADVICE = {
    "top": (
        "🧠 Верхний центр (ментально-ценностный) (top)\n\n"
    ...
    "balance": (
        "⚖️ Сбалансированы все три центра (balance)\n\n"
        "У тебя гармоничное распределение между верхним, сердечным и сексуальным центрами.\n"
